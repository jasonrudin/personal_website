    ...
    return (
        <div className={props.isActiveOnDesktop ? shownOnDesktop : hiddenOnDesktop}>
            <div className="flex md:w-full">
                <GalleryImage objectID = {props.objectID} imageList={props.art.imageArray} updateFullScreenArt={props.updateFullScreenArt} updateFullScreenMode = {props.updateFullScreenMode}/>
            </div>
